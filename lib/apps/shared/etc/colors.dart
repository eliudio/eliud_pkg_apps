...
class EliudColors {
  ...
  static RgbModel darkBlue = RgbModel(r: 0, g: 8, b: 60, opacity: 1.00);
  static RgbModel darkBlue2 = RgbModel(r: 0, g: 8, b: 80, opacity: 1.00);
  static RgbModel white = RgbModel(r: 255, g: 255, b: 255, opacity: 1.00);
  static RgbModel whiteTransparent =
      RgbModel(r: 255, g: 255, b: 255, opacity: 0.50);
  ...
  static RgbModel grayTransparent =
      RgbModel(r: 145, g: 121, b: 145, opacity: 0.30);
  ...
  static RgbModel lightbordeauxRed =
      RgbModel(r: 0x7c, g: 0x02, b: 0x1e, opacity: 1);
  static RgbModel ochre = RgbModel(r: 0xda, g: 0x9b, b: 0x00, opacity: 1);
  static RgbModel ochreTransparent =
      RgbModel(r: 0xda, g: 0x9b, b: 0x00, opacity: .2);
  static RgbModel lightBlueTransparent =
      RgbModel(r: 0xa3, g: 0x92, b: 0xf9, opacity: 1);
