...
Future<ProductModel> productToProductModel(ShopModel shop, InstallApp installApp, Tools newAppTools, Product product) async {
  ...
  if (product.assetLocation1 != null) {
    productImages.add(ProductImageModel(
        ...
        image: await newAppTools.uploadPublicPhoto(
